...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # the reason for providing _send_ is because send is overridden in Socket class.
    # Therefore in order to ensure that send can be used more meaningfully in other 
    # classes then _send_ was provided.
    # The same is the case with Object#id and Object#object_id.
  end
